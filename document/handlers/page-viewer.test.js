...
describe('checkOverlappingChunks', () => {
    it('keeps chunks when all bounding boxes are valid and non-overlapping', () => {
        ...
        const result = checkOverlappingChunks(input);
...
describe('Chunk strategy', () => {
    it('uses processed chunks when align is on', () => {
        ...
        const expected = checkOverlappingChunks(input);
        const result = resolveChunkStrategy('on', input);
    ...
    it('uses original chunks when align is off', () => {
        ...
        const result = resolveChunkStrategy('off', input);
