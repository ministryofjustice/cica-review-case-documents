...
/**
 * Helper function to mute console.error and console.warn during test execution.
 * Restores original functions after the test completes.
 *
 * @async
 * @param {Function} fn - The async function to execute with muted console.
